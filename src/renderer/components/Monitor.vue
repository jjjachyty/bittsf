<template>
  ...
  <v-container>
    ...
    <v-card>
      <v-card-title><span class="headline">方案1</span><span>人民币 OkEx USDT价格{{usdtExchange}}</span></v-card-title>
       <v-card-text>
        ...
        <br>
        剩余利润：<span class="headline red--text">{{marketTop.price[0][4] - (marketLow.price[1][4]*usdtExchange) | money}}</span>
       </v-card-text>

    </v-card>
    <br>
    <v-card>
      <v-card-title><span class="headline">方案2</span><span>Epay 美元购买  </span></v-card-title>
       <v-card-text>
        ...
        <br>
        剩余利润：<span class="headline red--text">{{(marketTop.price[0][4] - marketLow.price[1][4]*usdtExchange)-((marketLow.price[1][4] *0.01)+(25 * 6.29)) | money}}</span>
       </v-card-text>
